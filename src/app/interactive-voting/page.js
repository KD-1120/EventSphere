  ...
  return (
    <ThemeProvider theme={theme}>
        <Head>
          ...
          <meta name="description" content="Engage your audience with live polls, Q&A sessions, and voting features." />
        </Head>
        <Container fluid>
          <PageSection>
            <Container>
              <Row className="align-items-center">
                <Col lg={6}>
                  ...
                  <LeadText>Engage your audience with live polls, Q&A sessions, and voting features.</LeadText>
                </Col>
                <Col lg={6}>
                  <PlaceholderImage />
                </Col>
                ...
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription> Create multiple-choice or open-ended polls with real-time results</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Allow attendees to submit and upvote questions for speakers</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Enable participants to cast votes for awards, decisions, or competitions</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Works across desktop, tablet, and mobile for maximum reach</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
              </Row>
