  ...
  return (
    <ThemeProvider theme={theme}>
        <Head>
          ...
          <meta name="description" content="Track visitor engagement, ticket sales, and attendee demographics." />
        </Head>
        <Container fluid>
          <PageSection>
            <Container>
              <Row className="align-items-center">
                <Col lg={6}>
                  <MainHeading>Analytics Dashboard</MainHeading>
                  <LeadText>Track visitor engagement, ticket sales, and attendee demographics.</LeadText>
                </Col>
                <Col lg={6}>
                  <PlaceholderImage />
                </Col>
          ...
          <PageSection light>
            <Container>
              <Row className="align-items-center">
                ...
                <Col lg={6}>
                  <FeatureHeading>Data-Driven Event Management</FeatureHeading>
                  <FeatureDescription>
                  Make informed decisions with real-time insights into your event’s performance. From ticket sales to attendee behavior, our analytics dashboard provides the metrics you need to optimize future events.
                  </FeatureDescription>
                </Col>
              </Row>
            </Container>
          ...
          <PageSection>
            <Container>
              <Row className="align-items-center">
                <Col lg={6}>
                  <FeatureHeading>Visualize & Optimize</FeatureHeading>
                  <FeatureDescription>
                  Understand what’s working and refine your strategy for maximum impact.
                  </FeatureDescription>
                </Col>
                <Col lg={6}>
                  <PlaceholderImage />
                ...
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription> Monitor ticket sales, registrations, and attendance as they happen</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      <FeatureHeading>Engagement Metrics</FeatureHeading>
                      <FeatureDescription>Track poll responses, Q&A participation, and session interactions</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      <FeatureHeading> Conversion Tracking </FeatureHeading>
                      <FeatureDescription>See how your marketing efforts drive ticket sales</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    <IconWrapper>
                      <FileBarChart     size={24} strokeWidth={2} />
                    </IconWrapper>
                    <div>
                      <FeatureHeading> Custom Reports</FeatureHeading>
                      <FeatureDescription>Export data for deeper analysis and strategic planning</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
              </Row>
