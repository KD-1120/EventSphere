...
export default function Home() {
  return (
    <ThemeProvider theme={theme}>
        <Head>
          <title>Custom Event Pages</title>
          <meta name="description" content="Create branded event pages that reflect your unique style and engage your audience" />
           </Head>
        <Container fluid>
          <PageSection>
            <Container>
                ...
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Pages look perfect on any device - desktop, tablet, or mobile</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Apply your brand colors, logos, and fonts throughout</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Embed images, image galleries, and social media feeds</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Built-in tools to improve search engine visibility</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Create registration forms with custom fields for attendee data</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
              </Row>
