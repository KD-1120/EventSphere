  ...
  return (
    <ThemeProvider theme={theme}>
        <Head>
          ...
          <meta name="description" content="Sell tickets, manage attendees, and track sales in real-time." />
        </Head>
        <Container fluid>
          <PageSection>
            <Container>
                ...
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription> Offer general admission, VIP, early bird, or custom pricing options</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Generate scannable QR codes for smooth check-ins</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Get paid quickly with secure and reliable payment processing</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
                <Col md={6}>
                  <CapabilityItem>
                    ...
                    <div>
                      ...
                      <FeatureDescription>Run special offers to boost ticket sales</FeatureDescription>
                    </div>
                  </CapabilityItem>
                </Col>
              </Row>
